//package com.ruijing.base.local.upload.service.Impl;
//
//
...
//        String dirPath = SysConstant.dataPath + bucketName;
...
//        String dirPath = SysConstant.dataPath;
//        File dir = new File(dirPath);
//        if (dir.exists()) {
...
//        String dirPath = SysConstant.dataPath + bucketName + prefix;
//        File dir = new File(dirPath);
//        File[] fileList = dir.listFiles();
//        for (File file : fileList) {
...
//        String filePath = SysConstant.dataPath + bucketName + "/" + objectKey;
...
//        String sourceFilePath = SysConstant.dataPath + sourceBucketName + "/" + sourceObjectKey;
//        createBucket(targetBuckName);
//        String targetFilePath = SysConstant.dataPath + targetBuckName + "/" + targetObjectKey;
...
//        String tempPartFilePath = SysConstant.tempPath + "/" + uploadId + "/" + partNumber + ".temp";
...
//        String merageFilePath = SysConstant.dataPath + bucketName + "/" + objectKey;
...
//                String tempPartFilePath = SysConstant.tempPath + "/" + uploadId + "/" + partETag.getPartNumber() + ".temp";
//                String eTag = FileUtil.readFileContent(tempPartFilePath);
